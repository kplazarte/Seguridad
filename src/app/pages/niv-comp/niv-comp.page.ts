...
export class NivCompPage implements OnInit {
  ...
  async presentAlert() {
    ...
    if(check_one == true && parseInt(value_one) == 4) {
      await alert.present();
    } else if (check_two == true && parseInt(value_two) == 4){
      await alert.present();
    } else if (check_tree == true && parseInt(value_tree) == 4) {
      await alert.present();
    } else if (check_four == true && parseInt(value_four) == 4) {
      await alert.present();
    } else {
